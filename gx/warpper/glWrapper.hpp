...
namespace gx {
    namespace gl {
        ...
        static void uniform1iv(GLuint location, GLsizei size, GLint* value) {
            glUniform1iv(location, size, value);
            checkError();
        }

        static void uniform1i(GLuint location, GLint value) {
        ...
        static void blendEquationSeparate(GLenum modelRGB, GLenum modelAlpha) {
            glBlendEquationSeparate(modelRGB, modelAlpha);
            checkError();
        }
